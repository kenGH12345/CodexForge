...
function buildHistoryLine(metrics, state) {
  ...
  return {
    ...
    reflectionCycleEnabled: _reflectionCycleMetrics?.enabled ?? null,
    reflectionCycleRounds: _reflectionCycleMetrics?.rounds ?? null,
    reflectionCycleConverged: _reflectionCycleMetrics?.converged ?? null,
    reflectionCycleActionCount: _reflectionCycleMetrics?.actionCount ?? null,
    reflectionCycleDurationMs: _reflectionCycleMetrics?.durationMs ?? null,
