...
class SkillEvolutionEngine {
   ...
   * Delegates to skill-file-templates module (ADR-41) to eliminate duplication.
   *
   * @param {SkillMeta} meta
   */
  _createSkillFile(meta) {
    const { createSkillFile } = require('./skill-file-templates');
    createSkillFile({
      meta,
      skillsDir: this.skillsDir,
      onSkillFileCreated: this.onSkillFileCreated,
    });
  }
