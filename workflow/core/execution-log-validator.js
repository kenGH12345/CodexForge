...
// ═══════════════════════════════════════════════════════════════════════════
// Section 1: Standard Execution Flow Templates
// ═══════════════════════════════════════════════════════════════════════════
 ...
 *
 * Design: Template-based validation allows flexible matching
 *         without rigid hardcoding.
 */
const STANDARD_EXECUTION_FLOW = {
  // Stage 1: ANALYSE - Requirements Analysis
  ...
  // Stage 2: ARCHITECT - Architecture Design
  ...
  // Stage 3: PLAN - Execution Planning
  [WorkflowState.PLAN]: {
  ...
  // Stage 5: TEST - Testing & Validation
  [WorkflowState.TEST]: {
