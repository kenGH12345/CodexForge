...
version: 1.0.0
type: domain-skill
domains: [frontend, backend, typescript]
dependencies: []
load_level: task
max_tokens: 800
triggers:
...
| Version | Date | Change |
|---------|------|--------|
| v1.0.0 | 2026-04-22 | Initial creation |
...
<!-- 
  ...
  1. AgentHub Knowledge Base (UUID: 86d363ab81634904b1cbc1b46acc66bc)
     ...
     - Query: "TypeScript development patterns best practices patterns"
     - Domains: frontend, backend, typescript
  ...
  > /wf enrich-skill typescript-dev
-->