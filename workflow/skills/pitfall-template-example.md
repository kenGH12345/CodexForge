---
name: pitfall-template-example
version: 1.0.0
type: domain-skill
domains: [pitfall, template, example]
dependencies: []
load_level: task
max_tokens: 800
triggers:
  keywords: []
  roles: []
description: "Auto-discovered skill from pitfall-template-example.md"
---

# Skill: pitfall-template-example
...
<!--
  ...
  1. AgentHub Knowledge Base (UUID: 86d363ab81634904b1cbc1b46acc66bc)
     ...
     - Query: "Auto-discovered skill from pitfall-template-example.md best practices patterns"
     - Domains: pitfall, template, example
  ...
  > /wf enrich-skill pitfall-template-example
-->