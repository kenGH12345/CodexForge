...
version: 1.0.0
type: domain-skill
domains: [unity, csharp, game, xlua, racing-game, wepop]
dependencies: []
load_level: task
max_tokens: 800
triggers:
  keywords: []
  roles: []
description: "AI-refined domain skill for WePop Unity racing game project (64K+ symbols). Covers XLua integration, Command/Observer/Pipeline patterns, Core vs LiteCore architecture, memory management, and kart-racing-specific conventions."
---
...
| Version | Date | Change |
|---------|------|--------|
| v1.0.0 | 2026-04-28 | Initial creation |
...
<!-- 
  ...
  1. AgentHub Knowledge Base (UUID: 86d363ab81634904b1cbc1b46acc66bc)
     ...
     - Query: "AI-refined domain skill for WePop Unity racing game project (64K+ symbols). Covers XLua integration, Command/Observer/Pipeline patterns, Core vs LiteCore architecture, memory management, and kart-racing-specific conventions. best practices patterns"
     - Domains: unity, csharp, game, xlua, racing-game, wepop
