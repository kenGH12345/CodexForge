...
> Auto-generated by WorkFlowAgent. Last updated: 2026-04-24T14:21:17.565Z
...
> Auto-distilled. Last updated: 2026-04-24T13:29:09.309Z

### Module Map

| Module | Files | Classes | Functions |
|--------|-------|---------|-----------|
| `workflow/core` | 269 | 161 | 3274 |
| `workflow/tools` | 16 | 4 | 320 |
...
- **filter** ← 2911 refs, 21 calls [utility]
- **entries** ← 1750 refs, 10 calls [utility]
- **process** ← 1706 refs, 8 calls [utility]
- **parse** ← 1666 refs, 18 calls [utility]
- **stage** ← 1558 refs, 59 calls [hub]
- **outputDir** ← 1444 refs, 14 calls [utility]
- **summary** ← 1394 refs, 46 calls [utility]
- **projectRoot** ← 1355 refs, 20 calls [utility]
- **lines** ← 1231 refs, 13 calls [utility]
- **score** ← 1136 refs, 6 calls [utility]
